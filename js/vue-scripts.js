...
const vueAppFolio = new Vue({
    ...
    data: {
        ...
        projects: [
            {
                name: 'Masmic',
                type: projectTypeConst.WEBAPP + ' ' + projectTypeConst.ALL,
            ...
            {
                name: 'MSMEx',
                type: projectTypeConst.WEBAPP + ' ' + projectTypeConst.WEBSITE + ' ' + projectTypeConst.ALL,
            ...
            },
            {
                ...
                type: projectTypeConst.OTHER + ' ' + projectTypeConst.ALL,
            ...
            {
                name: "Pro Sports 11",
                type: projectTypeConst.WEBSITE + ' ' + projectTypeConst.ALL,
            ...
            {
                name: "Samsung S21 Ultra: A Long Term Detailed Review",
                type: projectTypeConst.OTHER  + ' ' + projectTypeConst.ALL,
                description: "Here is a look at the new Galaxy S21 from Samsung in the new Phantom Black color! It has been over 6 months since we first got my hands on the Samsung Galaxy S21 Ultra - Samsung’s latest premium flagship smartphone. In this video, we are going to review and share with you some new experiences we've had with The S21 Ultra after 6 months of daily personal usage, and find out whether or not it's right for you or someone you know. Is the premium experience worth the premium price tag of 1 lakh +?",
                title: "",
                image: '',
                thumbnail: `https://i.ytimg.com/vi/1PEF0tGC5m0/mqdefault.jpg`,
                action: 'IFRAME',
                link: 'https://www.youtube.com/embed/1PEF0tGC5m0?autoplay=0&rel=0',
            },
            {
                name: "Asus Zephyrus G14 | 1 Year Long Term Review",
                type: projectTypeConst.OTHER  + ' ' + projectTypeConst.ALL,
                description: "Asus Zephyrus G14 has shown it's worth and flows with time. This is a complete review of the device after a year of usage.",
                title: "",
                image: '',
                thumbnail: `https://i.ytimg.com/vi/sRUpCgbPL84/mqdefault.jpg`,
                action: 'IFRAME',
                link: 'https://www.youtube.com/embed/sRUpCgbPL84?autoplay=0&rel=0',
            },
            {
                name: "WhatsApp's new policy update 2021 | EXPLAINED",
                type: projectTypeConst.OTHER  + ' ' + projectTypeConst.ALL,
                description: "What is whatsapp's new policy? How does it affect you? Should you move to other platforms?",
                title: "",
                image: '',
                thumbnail: `https://i.ytimg.com/vi/deb54p7sa8k/mqdefault.jpg`,
                action: 'IFRAME',
                link: 'https://www.youtube.com/embed/deb54p7sa8k?autoplay=0&rel=0',
            },
            {
                name: "Chitkul | Last village and first voter of India",
                type: projectTypeConst.OTHER + ' ' + projectTypeConst.ALL,
                description: "Journey to the edge of India. To the very last village of India. Special Things To Do in Kalpa & Chitkul On the journey meet India's very First Voter: Shyam Saran Negi Ji (104 years old) He used to be a teacher when he was young, They still call him MASTER JI there 😊",
                title: "",
                image: '',
                thumbnail: `https://i.ytimg.com/vi/hxQjnmqvS64/mqdefault.jpg`,
                action: 'IFRAME',
                link: 'https://www.youtube.com/embed/hxQjnmqvS64?autoplay=0&rel=0',
            },
            {
                name: "Lohri at singhu border | farmers bill protest coverage",
                type: projectTypeConst.OTHER + ' ' + projectTypeConst.ALL,
                description: "This is neither a news report nor a documentary. It is an experience of two novice kids who wanted to celebrate Lohri with the farmers. This video will tell you how every farmer is fighting the odds just to safeguard his/her existence.",
                title: "",
                image: '',
                thumbnail: `https://i.ytimg.com/vi/3lJuZoXzlm4/mqdefault.jpg`,
                action: 'IFRAME',
                link: 'https://www.youtube.com/embed/3lJuZoXzlm4?autoplay=0&rel=0',
            },
            {
                name: "Rann of Kutch in Full Moon - Gujrat travel Itenary",
                type: projectTypeConst.OTHER,
                description: "Come on board on the 4-day journey to Gujrat and let's witness the magnificent White Desert, Rann of Kutch, together. That too on a full moon.",
                title: "",
                image: '',
                thumbnail: `https://i.ytimg.com/vi/yRQ0WHdSJGY/mqdefault.jpg`,
                action: 'IFRAME',
                link: 'https://www.youtube.com/embed/yRQ0WHdSJGY?autoplay=0&rel=0',
            },
        ],
    },
    computed: {
